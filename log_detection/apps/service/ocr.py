...
from apps.service.instruct_scan import InstructScanService
from apps.config.config import Config
logger = logging.getLogger(__name__)


class OcrTool:
    det_model_dir = 'apps/model/ocr/ch_PP-OCRv4_det_infer'
    rec_model_dir = 'apps/model/ocr/ch_PP-OCRv4_rec_infer'
    cls_model_dir = 'apps/model/ocr/ch_ppocr_mobile_v2.0_cls_infer'
    # 优化 OCR 参数配置
