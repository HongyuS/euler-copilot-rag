...
class DynamicWeightKeyWordSearcher(BaseSearcher):
    """
    动态加权关键词检索
    """
    name = SearchMethod.DYNAMIC_WEIGHTED_KEYWORD.value
    ...
    async def search(
        ...
        """
        try:
            chunk_entities = await ChunkManager.get_top_k_chunk_by_kb_id_dynamic_weighted_keyword(kb_id, query, top_k, doc_ids, banned_ids)
